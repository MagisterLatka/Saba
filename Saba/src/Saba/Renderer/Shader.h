...
namespace Saba {
	...
	public:
		...
		virtual void SetUniformFloat1v(const std::string& name, const float* value, int count) = 0;
		virtual void SetUniformFloat2(const std::string& name, const glm::vec2& value) = 0;
		virtual void SetUniformFloat3(const std::string& name, const glm::vec3& value) = 0;
		virtual void SetUniformFloat4(const std::string& name, const glm::vec4& value) = 0;

		virtual void SetUniformInt1(const std::string& name, int value) = 0;
		virtual void SetUniformInt1v(const std::string& name, const int* value, int count) = 0;
