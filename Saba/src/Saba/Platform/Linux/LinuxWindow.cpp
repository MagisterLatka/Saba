...
void LinuxWindow::Init(const WindowProps& props) {
    ...
    glfwSetFramebufferSizeCallback(m_Window, [](GLFWwindow* window, int width, int height) {
        ...
        data.swapChain->Resize(data.width, data.height);
    ...
    m_Data.swapChain = CreateScope<VulkanSwapChain>(m_Surface, m_Data.width, m_Data.height);
}
void LinuxWindow::Shutdown() {
    m_Data.swapChain.reset();

    vkDestroySurfaceKHR(VulkanContext::GetContextFromApplication()->GetInstance(), m_Surface, nullptr);
